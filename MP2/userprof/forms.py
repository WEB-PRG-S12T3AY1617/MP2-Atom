...
class RegisterForm(UserCreationForm):
    ...
    degreeoroffice = forms.CharField(help_text = 'Enter your degree/office. Whatever you input here will be set to your profile.')

    class Meta:
        model = User
        fields = ['username','first_name', 'last_name', 'degreeoroffice' ,'email', 'password1', 'password2']
        help_texts = {
